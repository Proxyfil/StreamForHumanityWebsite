...
<template>
  <div class="pt-16 px-8 pb-8">
    ...
    <div class="w-full grid gird-cols-2 gap-x-4 gap-y-6 gap-4 mt-8" v-else-if="selected == ''" id="infographics_global">
      <div class="flex flex-col items-center">
        <a v-bind:href="'/infographics/one.png'" target="_blank" class="min-h-[300px] blur-load" v-bind:style="{ 'background-image': 'url(' + streamersData['AMINEMATUE'].lazyload + ')' }"><img class="w-96" v-bind:alt="'infographie globale'" v-bind:src="'/infographics/one.png'" loading="lazy"></a>
      </div>
      <div class="flex flex-col items-center">
        <a v-bind:href="'/infographics/two.png'" target="_blank" class="min-h-[300px] blur-load" v-bind:style="{ 'background-image': 'url(' + streamersData['AMINEMATUE'].lazyload + ')' }"><img class="w-96" v-bind:alt="'infographie globale #2'" v-bind:src="'/infographics/two.png'" loading="lazy"></a>
      </div>
    </div>
  </div>
</template>
